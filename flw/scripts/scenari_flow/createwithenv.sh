...
http --form --json POST http://keycloak.test/api/dm/create Authorization:"Bearer $TOKEN" <<< '{"Name":"fabrizio","Env":["queue=pipeline0103041111"],"Image":"nginx","Network":"net1","Volumes":[]}'
